...
// Пример списка моделей для категории "Животные"
const animalsModels = [
  { id: '1', name: 'Фигурка лягушки' },
  { id: '2', name: 'Котёнок' },
  { id: '3', name: 'Собака' },
  { id: '4', name: 'Птица' },
];

export default function AnimalsCategoryPage() {
  return (
    <div className="min-h-screen bg-[#ece9dd]">
      <Header />
      <div className="pt-24 px-8 max-w-4xl mx-auto">
        <h1 style={{ fontSize: '2rem', fontWeight: 700, marginBottom: 24 }}>Животные</h1>
        {animalsModels.length === 0 ? (
