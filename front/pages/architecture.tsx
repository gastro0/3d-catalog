...
// Пример списка моделей для категории "Архитектура"
const architectureModels = [
  { id: '1', name: '3D Дом №1' },
  { id: '2', name: 'Макет здания' },
  { id: '3', name: 'Арка' },
  { id: '4', name: 'Башня' },
];
  ...
  return (
    <div className="min-h-screen bg-[#ece9dd]">
      ...
      <div className="pt-24 px-8 max-w-4xl mx-auto">
        <h1 style={{ fontSize: '2rem', fontWeight: 700, marginBottom: 24 }}>Архитектура</h1>
        {architectureModels.length === 0 ? (
