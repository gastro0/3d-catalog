...
// Пример списка моделей для категории "Игрушки"
const toysModels = [
  { id: '1', name: '3D Пазл' },
  { id: '2', name: 'Игрушечная машинка' },
  { id: '3', name: 'Конструктор' },
  { id: '4', name: 'Фигурка героя' },
];

export default function ToysCategoryPage() {
  return (
    <div className="min-h-screen bg-[#ece9dd]">
      <Header />
      <div className="pt-24 px-8 max-w-4xl mx-auto">
        <h1 style={{ fontSize: '2rem', fontWeight: 700, marginBottom: 24 }}>Игрушки</h1>
        {toysModels.length === 0 ? (
